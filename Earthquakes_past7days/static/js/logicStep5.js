...
d3.json(earthquakeData).then(function(data) {
    ...
    // This function determines the radisu of the earthquakes marker based on its magnitude.
    ...
    L.geoJSON(data,{
        ...
        // Location of the earthquake after the marker has been created and stuled.
